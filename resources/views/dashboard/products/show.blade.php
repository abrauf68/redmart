            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" min="1" name="special_order_number" value="{{ $customer->special_order_number }}" class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label>Multiplier</label>
                        <input type="number" min="0" step="0.01" name="special_multiplier" value="{{ $customer->special_multiplier }}" class="form-control" required>
                    </div>

                    <div class="mb-3">
                        <label>Commission Rate (%)</label>
                        <input type="number" max="100" min="0" name="special_commission_percentage" value="{{ $customer->special_commission_percentage }}" class="form-control" required>
                    </div>
